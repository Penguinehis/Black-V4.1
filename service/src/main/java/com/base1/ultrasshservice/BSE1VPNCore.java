...
* @author SlipkHunter
*/
public class BSE1VPNCore
{
	private static BSE1VPNCore mInstance = null;
	private Context mContext;
	
	public static void init(Context context) {
		if (mInstance == null) {
			mInstance = new BSE1VPNCore(context);
		}
	}
	
	private BSE1VPNCore(Context context) {
		mContext = context;
    ...
    private void createNotificationChannels() {
        ...
        NotificationChannel mChannel = new NotificationChannel(BSE1VPNService.NOTIFICATION_CHANNEL_BG_ID,
        ...
        mChannel = new NotificationChannel(BSE1VPNService.NOTIFICATION_CHANNEL_NEWSTATUS_ID,
        ...
        mChannel = new NotificationChannel(BSE1VPNService.NOTIFICATION_CHANNEL_USERREQ_ID,
