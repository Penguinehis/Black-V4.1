...
import com.base1.ultrasshservice.aidl.IUltraSSHServiceInternal;
...
import com.base1.ultrasshservice.tunnel.TunnelManagerThread;
...
import com.base1.ultrasshservice.util.DummyActivity;

public class BSE1VPNService extends Service
implements SkStatus.StateListener
{
	private static final String TAG = BSE1VPNService.class.getSimpleName();
	public static final String START_SERVICE = "com.base1.net:startTunnel";
	...
	private final IBinder mBinder = new IUltraSSHServiceInternal.Stub() {
        ...
        @Override
        public void stopVPN() {
            BSE1VPNService.this.stopTunnel();
        }
	...
	public void endTunnelService() {
		mHandler.post(new Runnable() {
				...
				public void run() {
					...
					stopSelf();
					SkStatus.removeStateListener(BSE1VPNService.this);
				}
			});
	}
	...
	public static PendingIntent getGraphPendingIntent(Context context) {
        ...
        intent.setComponent(new ComponentName(context, context.getPackageName() + ".BSE1VPNMainActivity"));
	...
	public static final String TUNNEL_SSH_RESTART_SERVICE = BSE1VPNService.class.getName() + "::restartservicebroadcast",
	TUNNEL_SSH_STOP_SERVICE = BSE1VPNService.class.getName() + "::stopservicebroadcast";
