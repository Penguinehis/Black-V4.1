...
package com.base1.ultrasshservice.tunnel.vpn;
			...
			boolean enabledFilter, boolean filterBypassMode, String[] filterApps, boolean enableTethering) throws java.lang.Exception
	{
		...
		try
		{
			...
			if (Build.VERSION.SDK_INT >= 21) {
				builder.addDisallowedApplication("com.base1.net");
			...
			tunFd = builder
					...
					.setConfigureIntent(BSE1VPNService.getGraphPendingIntent(mHostService.getContext()))
					.establish();
